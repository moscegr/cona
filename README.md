...
| **Construcción de Bases de Datos** | **COBD-04** | 4° Semestre | 7 hrs/sem | 126 Horas | 13 Créditos | 7 Evaluaciones (100%) | [Abrir Módulo](./construccion-de-bases-de-datos/index.html) |
...
- **40% Firmas:** Actividades continuas de aula, ejercicios resueltos del problemario (10 ejercicios por tema), diagramas de flujo/topologías/esquemas y reportes de prácticas en simulador.
- **10% Asistencias:** Asistencia y puntualidad reglamentaria (mínimo 80%) y programa de preceptorías académicas.
- **50% Proyecto Integrador / Evidencias SAE:** Proyectos funcionales ejecutables (archivos `.sql`, `.pkt`, scripts de Python) y Actividades de Evaluación Oficiales capturadas en el Sistema de Administración Escolar (SAE).
...
1. **Fase 1: Apertura (Activación y Contextualización):** Casos de estudio de la industria real (ciberseguridad, drones, colapsos de red, pérdidas financieras, inconsistencia de datos) y preguntas diagnósticas detonadoras.
2. **Fase 2: Desarrollo Conceptual:** Fundamentación teórica rigurosa, estándares internacionales (ISO/IEC 27000, IEEE 802.11, IEEE 802.1Q, IEEE 802.1D, SQL ANSI/ISO, RFC 1918, PEP 8, MCCEMS) y glosarios técnicos.
3. **Fase 3: Demostración y Modelado Paso a Paso:** Procedimientos guiados con código fuente y comandos documentados (MySQL, PostgreSQL, Cisco IOS CLI, Python 3, PowerShell, Linux, HTML5), pruebas de escritorio y diagramas vectoriales SVG interactivos.
4. **Fase 4: Aplicación Práctica:**
   - **Simuladores Interactivos en JavaScript Nativo:**
     ...
     - *COBD-04:* Diseñador de Diagramas MER y Cardinalidad, Verificador de Formas Normales (1FN, 2FN, 3FN), Generador DDL SQL, Simulador de Triggers de Auditoría, Constructor de Vistas Seguras, Simulador Transaccional ACID y Gestor DCL GRANT/REVOKE con backups.
